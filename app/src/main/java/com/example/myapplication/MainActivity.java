    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_insert.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (ed_book.length()<1 || ed_price.length()<1)
                    Toast.makeText(MainActivity.this,"欄位請不要留空",
                    ...
                    try {
                        ...
                        Toast.makeText(MainActivity.this,"新增fail:"+e.toString(),
                                Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onClick(View v){
                ...
                if (ed_book.length()<1 || ed_price.length()<1)
                    ...
                    try {
                        ...
                        Toast.makeText(MainActivity.this,"更新fail:"+e.toString(),
                                Toast.LENGTH_SHORT).show();
                    }
        ...
        btn_delete.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                if (ed_book.length()<1 )
                    Toast.makeText(MainActivity.this,"書名請不要留空",
                            Toast.LENGTH_SHORT).show();
                else{
                    try {
                        ...
                        Toast.makeText(MainActivity.this,"刪除fail:"+e.toString(),
                                Toast.LENGTH_SHORT).show();
                    }
                }
            } });
